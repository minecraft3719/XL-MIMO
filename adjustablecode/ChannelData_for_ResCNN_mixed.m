...
pathName = append("Channel_f",num2str(Lf),"n",num2str(Ln),"_Total_Model",num2str(num_Channel),"_",num2str(N),"ANTS_",num2str(num_sta),"by",num2str(num_ffading));
save([pathName],'Channel_mat_total')
